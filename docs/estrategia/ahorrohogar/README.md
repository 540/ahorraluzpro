# ahorrohogar — Plataforma de ahorro del hogar

> Proyecto de producto creado el 2026-05-18 siguiendo la metodología 540 (Kernel de Rumelt + Opportunity Solution Tree).
>
> **Alcance:** plataforma multi-vertical de ahorro en consumos básicos del hogar (luz → gas → combustible → banca). AhorraLuz V1 es el primer producto dentro de esta visión.
>
> **Inputs previos relevantes:**
> - [CLAUDE.md raíz del repo](../../../CLAUDE.md) — contexto técnico/producto de AhorraLuz V1
> - [docs/estrategia/verticales-ahorro-hogar.md](../verticales-ahorro-hogar.md) — análisis de verticales del 2026-05-17

## Estado del proyecto

| Fase | Documento | Estado |
|------|-----------|--------|
| Visión (abstracta) | [00-vision.md](00-vision.md) | ✅ Completada (2026-05-19) |
| Diagnóstico — Mercado | [01-diagnostico/01-estudio-mercado.md](01-diagnostico/01-estudio-mercado.md) | ✅ (2026-05-19) |
| Diagnóstico — Contexto producto | [01-diagnostico/02-contexto-producto.md](01-diagnostico/02-contexto-producto.md) | ✅ (2026-05-19) |
| Diagnóstico — Competencia | [01-diagnostico/03-estudio-competencia/](01-diagnostico/03-estudio-competencia/) | ✅ (2026-05-19) — 6 deep dives + análisis ligero + resumen cruzado |
| Diagnóstico — User research | [01-diagnostico/04-user-research/](01-diagnostico/04-user-research/) | ✅ (2026-05-20/21) — personas + journey + JTBD |
| Diagnóstico — Síntesis (problemas + oportunidades) | [01-diagnostico/05-problemas-oportunidades.md](01-diagnostico/05-problemas-oportunidades.md) | ✅ (2026-05-22) — 5 problemas + 10 oportunidades priorizadas |
| Modelo económico | [02-modelo-economico.md](02-modelo-economico.md) | ⬜ |
| Política guía (elige qué oportunidades atacar) | [03-politica-guia.md](03-politica-guia.md) | ⬜ |
